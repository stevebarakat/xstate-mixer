    ...
    <div>
      <div className="flex gap12">
        ...
        <div className="power-button">
          <input
            ...
            type="checkbox"
            value={state.context.trackFxData.delaysBypass[trackIndex]}
            ...
            checked={state.context.trackFxData.delaysBypass[trackIndex]}
          />
      ...
      <div className="flex-y">
        ...
        <input
          ...
          step={0.01}
          disabled={disabled}
          value={state.context.trackFxData.delaysMix[trackIndex]}
          onChange={(e: React.FormEvent<HTMLInputElement>): void => {
            send({
      ...
      <div className="flex-y">
        ...
        <input
          ...
          step={0.01}
          disabled={disabled}
          value={state.context.trackFxData.delaysTime[trackIndex]}
          onChange={(e: React.FormEvent<HTMLInputElement>): void => {
            send({
      ...
      <div className="flex-y">
        ...
        <input
          ...
          step={0.01}
          disabled={disabled}
          value={state.context.trackFxData.delaysFeedback[trackIndex]}
          onChange={(e: React.FormEvent<HTMLInputElement>): void => {
            send({
